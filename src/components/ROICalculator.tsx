    ...
    <div className="glass-panel flex flex-col h-full overflow-hidden">
      <div className="px-6 py-5 border-b border-slate-100/50 transition-colors">
        <div className="flex items-center gap-3">
          ...
          <h3 className="text-[11px] font-black uppercase tracking-[0.2em] text-slate-800 transition-colors">Returns Calculator</h3>
        </div>
      </div>
      ...
      <div className="p-6 flex-1 flex flex-col gap-6">
          ...
          <div>
            ...
            <div className="relative mt-2">
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-100 bg-white/50 py-3 pl-8 pr-4 text-sm font-black text-slate-900 transition focus:border-slate-900 focus:bg-white focus:outline-none focus:ring-4 focus:ring-slate-900/5"
              />
            </div>
          </div>
          <div>
            ...
            <div className="mt-2 flex flex-wrap gap-2">
              {ranges.map((r) => (
                <button
                  ...
                  className={`rounded-lg px-3 py-2 text-[10px] font-black uppercase tracking-wider transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-500 ${
                    roiTime === r.value 
        ...
        {calculatedRoi && (
          <div className="mt-auto rounded-2xl bg-slate-900 p-6 text-white shadow-xl shadow-slate-900/20 transition-colors">
            ...
            <div className="mt-6 space-y-3 border-t border-white/10 pt-4">
              <div className="flex justify-between text-[10px] font-black uppercase tracking-wider">
                ...
                <span className="text-white/80">{formatCurrency(roiAmount)}</span>
              </div>
              <div className="flex justify-between text-[10px] font-black uppercase tracking-wider">
