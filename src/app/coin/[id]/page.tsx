    ...
    return (
      <main className="flex min-h-screen items-center justify-center px-4 bg-white transition-colors">
        <div className="glass-panel flex max-w-md flex-col items-center gap-3 px-6 py-6 text-sm text-slate-600 transition-colors">
          ...
          <p className="font-bold uppercase tracking-widest text-[10px]">Loading coin details…</p>
        </div>
      </main>
    );
  }
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-10 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 rounded-full bg-white px-3 py-1.5 shadow-sm ring-1 ring-slate-100 transition-colors">
            ...
            <span className="text-[9px] font-black uppercase tracking-widest text-slate-500 transition-colors">Live Market Active</span>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-8 lg:grid lg:grid-cols-[1fr_380px]">
          <div className="min-w-0 space-y-8">
            ...
            <div className="grid gap-8">
              ...
              <MarketMetrics asset={asset as any} />
            </div>
              ...
              <div className="glass-panel overflow-hidden transition-colors">
                <div className="px-6 py-5 border-b border-slate-100/50 transition-colors">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-[11px] font-black uppercase tracking-[0.2em] text-slate-800 transition-colors">About {asset.name}</h3>
                  </div>
                </div>
                <div className="p-6 md:p-8">
                  <div className={`relative overflow-hidden transition-all duration-500 ${detailsExpanded ? "max-h-[2000px]" : "max-h-32"}`}>
                    <div className="prose prose-sm max-w-none text-slate-600 leading-relaxed font-medium transition-colors" dangerouslySetInnerHTML={{ __html: asset.description.en }} />
                    {!detailsExpanded && <div className="absolute bottom-0 left-0 h-20 w-full bg-gradient-to-t from-white/95 via-white/50 to-transparent transition-colors" />}
                  </div>
                  <button
                  ...
                  >
                    {detailsExpanded ? "Collapse Details" : "Read Full Description"}
                    <div className={`flex h-5 w-5 items-center justify-center rounded-full bg-indigo-50 transition-all duration-500 ${detailsExpanded ? "rotate-180" : ""}`}>
